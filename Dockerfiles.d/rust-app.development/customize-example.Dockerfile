FROM ghcr.io/mazgi/rust-app.development

LABEL org.opencontainers.image.source="https://github.com/mazgi/container-images/blob/main/Dockerfiles.d/rust-app.development/customize-example.Dockerfile"
