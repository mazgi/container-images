...
LABEL org.opencontainers.image.source="https://github.com/mazgi/container-images/blob/main/Dockerfiles.d/dotnet-app.development/customize-example.Dockerfile"
