...
LABEL org.opencontainers.image.source="https://github.com/mazgi/container-images/blob/main/Dockerfiles.d/ruby-webapp.development/customize-example.Dockerfile"
