...
LABEL org.opencontainers.image.source="https://github.com/mazgi/dockerfiles/blob/main/Dockerfile.d/debian-node-webapp.development/customize-example.Dockerfile"
